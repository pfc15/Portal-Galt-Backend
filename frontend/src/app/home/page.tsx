        ...
        <main className="w-full h-full">
            ...
            <div className="flex w-full h-[80vh]">
                ...
                <div className="w-[40%] items-center justify-center h-[54vh] pt-20 text-justify mr-[20px]">
                    ...
                    <h1 className="text-black font-wight-bold text-4xl">
                        Somos um cursinho voluntário criado em 2015 por 4 estudantes da Universidade de Brasília com objetivo de ser muito mais que um cursinho, mas um local de duplo impacto e uma instituição de empoderamento de jovens de baixa renda até o ensino superior.
